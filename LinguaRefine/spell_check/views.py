...
def grammar_check(request):
    if request.method == "POST":
        ...
        corpus = read_corpus(r"big_corpus.txt")
        ...
        happy_tt = HappyTextToText("T5", "vennify/t5-base-gramar-correction")
        ...
        return JsonResponse(
            {
                ...
                "corrections": check_correct_spelling(
                    words_not_found, vocab, word_probabs
                ),
            }
        )
